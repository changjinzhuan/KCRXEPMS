...
import cn.kcrxorg.kcrxepms.businessmodule.cmdinfo.PackageCMD;
import cn.kcrxorg.kcrxepms.businessmodule.cmdinfo.busiInfo;
import cn.kcrxorg.kcrxepms.businessmodule.cmdinfo.packInfo;
import cn.kcrxorg.kcrxepms.businessmodule.cmdinfo.stackInfo;
import cn.kcrxorg.kcrxepms.businessmodule.datainfo.PackageData;
import cn.kcrxorg.kcrxepms.businessmodule.datainfo.packinfo;
     ...
     //   line_businfo.setOrientation(LinearLayout.VERTICAL);//设置布局方向
        ...
        if (packageCMD.getStackInfoList().length > 0)//如果需要选择库间的话
        {
            if(packageCMD.getStackInfoList()[0].getSstackName()!=null)
            {
                ...
                for(cn.kcrxorg.kcrxepms.businessmodule.cmdinfo.stackInfo stackInfo:packageCMD.getStackInfoList())
                {
